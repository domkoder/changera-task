        ...
        <Flex justify="space-between">
          <Box color="#57606a" fontWeight="500">
            ...
            <Text mr={4} maxWidth="500px" noOfLines={2} fontSize="14px" mb="3">
              ...
              ideas, and resources! 50 project ideas to learn by doing complete
              with project briefs, layout ideas, and resources!
            </Text>
            <HStack fontSize="12px" marginTop="10px" gap="10px">
              <Text>
                <Box as="span" />
                JavaScript
              </Text>
